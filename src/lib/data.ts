...
export const TESTIMONIALS_DATA = [
  {
    ...
    rating: 5,
    review: "Our Kerala honeymoon was absolutely magical! VoyageIndia took care of every detail — from the houseboat experience to the Munnar sunrise. The team was incredibly responsive and helpful throughout the trip.",
    destination: "Kerala",
  ...
  },
  {
    ...
    rating: 5,
    review: "Bali with VoyageIndia was a dream come true! Every resort, every activity was perfectly planned. They even arranged a surprise anniversary dinner. Highly recommend for international tours!",
    destination: "Bali",
  ...
  },
  {
    ...
    rating: 4,
    review: "The Manali-Spiti trek was challenging and beautiful. VoyageIndia's support team was available 24/7 during the trip. Excellent arrangements considering the remote locations we visited.",
    destination: "Himachal Pradesh",
  ...
  },
  {
    ...
    rating: 5,
    review: "Third trip booked through VoyageIndia and it keeps getting better! The Andaman package was phenomenal. Havelock Island snorkeling experience was once in a lifetime.",
    destination: "Andaman",
